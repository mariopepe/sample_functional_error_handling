...
abstract class _$$RefreshTodosImplCopyWith<$Res> {
  factory _$$RefreshTodosImplCopyWith(
          _$RefreshTodosImpl value, $Res Function(_$RefreshTodosImpl) then) =
      __$$RefreshTodosImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$RefreshTodosImplCopyWithImpl<$Res>
    extends _$TodoEventCopyWithImpl<$Res, _$RefreshTodosImpl>
    implements _$$RefreshTodosImplCopyWith<$Res> {
  __$$RefreshTodosImplCopyWithImpl(
      _$RefreshTodosImpl _value, $Res Function(_$RefreshTodosImpl) _then)
      : super(_value, _then);
}

/// @nodoc

class _$RefreshTodosImpl implements RefreshTodos {
...
abstract class RefreshTodos implements TodoEvent {
  const factory RefreshTodos() = _$RefreshTodosImpl;
}
...
abstract class Error implements TodoState {
  const factory Error(final TodoFailure failure) = _$ErrorImpl;
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(final List<Todo> todos) : _todos = todos;
...
abstract class Success implements TodoState {
  const factory Success(final List<Todo> todos) = _$SuccessImpl;
